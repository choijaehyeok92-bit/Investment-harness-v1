...
- Decision: WATCH
- Position band: NONE
- Total score: 71/100 (Starter / Watch)
- Hard Veto status: INVESTIGATE
- Price: ₩1,055,000 (2026-09-04 KRX close)
- Expectation gap: Base SOTP approximately ₩1,050,000 versus current price ₩1,055,000; no meaningful margin of safety
- Asymmetry: Bear/Base/Bull approximately ₩499,000 / ₩1,050,000 / ₩1,593,000; subjective probability-weighted value approximately ₩1,048,000
- Evidence change since prior review: Initial repository coverage using the supplied 2026 H1 half-year report and corrected 2025 business report, plus post-period public filings for safety incident, contract changes, KAI stake and 2026-09-04 market prices.
- Thesis change: Initial coverage. Strong defense export thesis is conditioned on cash conversion, per-share value after 2025 dilution, and disciplined returns on global localization / strategic equity investments.
- What would change the decision next: Multiple simultaneous improvements in OCF/FCF per share, project ROIC, customer diversification, safety execution and expectation gap.
- Macro pacing: company_specific; geopolitical demand supports the business outlook but does not change the company score.
=======
